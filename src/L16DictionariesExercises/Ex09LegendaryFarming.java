...
public class Ex09LegendaryFarming {
...
class UniqueMaterial implements Collectible, Comparable<UniqueMaterial> {
    private String type;
...
class Junk implements Collectible, Comparable<Junk> {
    private String type;
    private int quantity;
